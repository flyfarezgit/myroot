...
<html>
    ...
    <body><jsp:include page="tag-manager-body.jsp" />
        ...
        <li><a href="/privacy-policy">Privacy Policy</a></li>
            <p>&copy 2020 Tripsfares.com All Rights Reserved</p>
        </div>
            ...
            <div class="price-details">
                ...
                <div class="person-price">
                    ...
                    <div class="fcp">
                        ...
                        <span>$ <fmt:formatNumber type="number" maxFractionDigits="2" value="${bookingRequest.flightResult.fare.adultFare+bookingRequest.flightResult.fare.adultTax+bookingRequest.flightResult.fare.adultMarkup}"/> </span>
                    </div>
                    <%-- <div class="tfp">
                ...
                <div class="person-price">
                    ...
                    <div class="fcp">
                        ...
                        <span>$ <fmt:formatNumber type="number" maxFractionDigits="2" value="${bookingRequest.flightResult.fare.childFare+bookingRequest.flightResult.fare.childTax+bookingRequest.flightResult.fare.childMarkup}"/></span>
                    </div>
                    <%-- <div class="tfp">
                ...
                <div class="person-price">
                    ...
                    <div class="fcp">
                        ...
                        <span>$ <fmt:formatNumber type="number" maxFractionDigits="2" value="${bookingRequest.flightResult.fare.infantFare+bookingRequest.flightResult.fare.infantTax+bookingRequest.flightResult.fare.infantMarkup}"/></span>
                    </div>
                    <%-- <div class="tfp">
                ...
                <div class="person-price">
                    ...
                    <div class="fcp">
                        ...
                        <span>$ <fmt:formatNumber type="number" maxFractionDigits="2" value="${bookingRequest.flightResult.fare.infantWsFare+bookingRequest.flightResult.fare.infantWsTax+bookingRequest.flightResult.fare.infantWsMarkup}"/></span>
                    </div>
                    <%-- <div class="tfp">
                ...
                <div class="total-price">
                    <span>Final Total:</span><span>$ <fmt:formatNumber type="number" maxFractionDigits="2" value="${bookingRequest.flightResult.fare.grandTotal}"/></span>
                </div>
