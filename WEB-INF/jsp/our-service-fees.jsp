...
<tr>
   <td>
      <div style="color:#303030;font-weight:bold;">Online Air Transaction Service Fees</div>
      <div style="font-size:12px;">On most airfares a service fee up to $35? is charged on a per-passenger, per-ticket basis. **</div>
   </td>
   <td>
...
Government imposed taxes and fees are subject to change. You will only be charged the final total amount as shown.</div>
     <br>
     <div style="color:#303030;font-weight:bold;"> Certain exceptions to the above service fees apply</div>
     ...
     <br>
     <div style="color:#303030;font-weight:bold;">Read more about service / booking fees in our <a href="/terms-and-conditions">terms and conditions</a>.</div>
   </td>
</tr>
</tbody>
</table>
