    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                ...
                <div class="engine-bg city-page-en">
                ...
                <div class="ee-navbar-items">
                    <li><a href="#"><span>Flights</span></a></li>
                        ...
                        <h1 class="city-page-heading">Flights To <span style="text-transform:capitalize;">${fn:replace(page,'-',' ')}</span> </h1>
                ...
                <c:if test="${dealResponse.response.size() > 0}">
                    <div class="best-deals cityapi-section" style="display: flex;flex-wrap: wrap;">
