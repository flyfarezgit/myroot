...
$(document).ready(function(){
    ...
    <style>
      .engine-bg{background-image: url('/resources/images/${fn:toLowerCase(pageResponse.pageType)}/${pageResponse.pageValue}.jpg'), url('/resources/images/enginebg.webp');
...
<body><jsp:include page="tag-manager-body.jsp" />
    ...
    <div class="engine-bg">
        <div class="bg-overlay">
            <h1><span style="text-transform:capitalize;">${pageResponse.pageName}</span> Reservas</h1>
    ...
    <div class="about-airline-city">
        ...
        <div class="about-topic">
            <div class="topic-head">
                Información útil sobre ${pageResponse.pageName}
            </div>
            <div class="topic-content">
                <div class="alternate-rows">
                    <div class="table-row">
                        <div class="table-cell">Aeropuertos principales:</div>
                        <div class="table-cell">${pageResponse.airportHub}</div>
                    </div>
                    <div class="table-row">
                        <div class="table-cell">Sede:</div>
                        <div class="table-cell">${pageResponse.headQuarters}</div>
                    </div>
                    <div class="table-row">
                        <div class="table-cell">Ruta Popular:</div>
                        <div class="table-cell"><a href="#">${pageResponse.popularRoutes}</a></div>
                    </div>
                    <div class="table-row">
                        <div class="table-cell">Destinos Populares:</div>
        ...
        <div class="about-topic">
            <div class="topic-head">
                ${pageResponse.pageName} Tendencias de viaje
            </div>
            <div class="topic-content">
	...
	<c:if test="${dealResponse.response.size() > 0}">
        <div class="best-deals" style="display: flex;flex-wrap: wrap;">
            <div class="dealHeadScn">
                <p class="dealHeadScn-heading">Piense con anticipación y planifique su próximo viaje</p>
            </div>
